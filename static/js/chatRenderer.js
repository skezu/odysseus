...
export function displayMetrics(messageElement, metrics) {
  ...
  metricsContainer.addEventListener('click', (e) => {
    ...
    const ctxColor = ctxPct >= 85 ? 'var(--red, #d97757)' : ctxPct >= 70 ? '#ff9900' : 'var(--color-muted-alt, #6b7280)';
  ...
  if (ctxPct !== undefined && ctxPct > 0) {
    ...
    const ctxColor = ctxPct >= 85 ? 'var(--red, #d97757)' : ctxPct >= 70 ? '#ff9900' : 'var(--green, #98c379)';
